    ...
    initScene(){
        ...
        loader.load(
			...
			function ( gltf ) {
                ...
                if (self.cart!=undefined && self.cursor!=undefined && self.introsound!==undefined) self.loadingBar.visible = false;
        ...
        loader.load(
			...
			function ( gltf ) {
                ...
                if (self.apple!=undefined && self.cursor!=undefined && self.introsound!==undefined) self.loadingBar.visible = false;
        ...
        loader.load(
			...
			function ( gltf ) {
                ...
                if (self.cart!=undefined && self.apple!=undefined && self.introsound!==undefined) self.loadingBar.visible = false;
