...
class ARButton2{
	...
	constructor( renderer, options, a, b, classname ) {
        ...
        if ( 'xr' in navigator ) {
			...
			navigator.xr.isSessionSupported( 'immersive-ar' ).then( ( supported ) => {
				...
				supported ? this.showStartAR( button,a,b ) : this.showARNotSupported( button );
